...
| I need a stabilization or containment pattern. ｜ 初動安定化または封じ込めの基本パターンが必要 | `L30-FRM-S01` Stabilization Checklist ｜ 初動安定化チェックリスト | Track containment, evidence preservation, and refusal-preservation recovery conditions ｜ 封じ込め、証拠保全、拒否権保全の回復条件を確認する |
...
| `L30-FRM-S01` | Stabilization Checklist ｜ 初動安定化チェックリスト | Post-incident stabilization and containment pattern ｜ 事故後安定化・封じ込めの基本パターン | [DOCX](./L30_FRM_S01_Stabilization_Checklist.docx) | [PDF](./L30_FRM_S01_Stabilization_Checklist.pdf) | — | — |
...
| `L30-FRM-S01` | Stabilization | [DOCX](./L30_FRM_S01_Stabilization_Checklist.docx) | [PDF](./L30_FRM_S01_Stabilization_Checklist.pdf) | Stabilization, containment, evidence preservation, and recovery tracking |
