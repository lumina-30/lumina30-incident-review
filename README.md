...
- [Boundary Review Floor ｜ 境界レビューフロア](https://lumina-30.github.io/lumina-30-overview/reference/boundary-review-floor/index.html)  
...
2. Open [FIRST_3_FILES.html](https://lumina-30.github.io/lumina30-incident-review/FIRST_3_FILES.html) and follow the three core working files.  
   [FIRST_3_FILES.html](https://lumina-30.github.io/lumina30-incident-review/FIRST_3_FILES.html) を開き、3つの中核作業ファイルに従う。
3. Apply [Irreversibility Decision Criteria](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Irreversibility_Decision_Criteria.html) before classifying the result.  
   結果分類の前に [Irreversibility Decision Criteria](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Irreversibility_Decision_Criteria.html) を適用する。
   For structural interpretation, refer to [Irreversibility Boundary Kernel](https://lumina-30.github.io/lumina30-incident-review/boundary-check/IRREVERSIBILITY_BOUNDARY_KERNEL.html).  
   構造的解釈には [Irreversibility Boundary Kernel](https://lumina-30.github.io/lumina30-incident-review/boundary-check/IRREVERSIBILITY_BOUNDARY_KERNEL.html) を参照する。

4. If evidence is absent or unverifiable, apply [Absence Rule Check](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Absence_Rule_Check.html).  
   証拠が存在しない、または検証不能な場合は [Absence Rule Check](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Absence_Rule_Check.html) を適用する。
5. Classify the result using [Boundary Check Result Classification](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Boundary_Check_Result_Classification.html), then choose a response template if needed.  
   [Boundary Check Result Classification](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Boundary_Check_Result_Classification.html) で結果を分類し、必要に応じて応答テンプレートを選ぶ。
...
|---|---|
| Incident reviewer | Apply the [Boundary Check](https://lumina-30.github.io/lumina30-incident-review/boundary-check/LUMINA-30_Boundary_Check.html) to AI-related incidents, near misses, or loss-of-control cases. |
...
If the answer is unclear, absent, unverifiable, or merely formal, treat the case as a post-LUMINA risk for LUMINA-30 review purposes and proceed to the [Absence Rule Check](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Absence_Rule_Check.html) and [Boundary Check Result Classification](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Boundary_Check_Result_Classification.html).
...
| 立場 | 今すぐ取れる行動 |
|---|---|
| 事故調査者 | AI関連事故、ニアミス、制御喪失事例に [Boundary Check](https://lumina-30.github.io/lumina30-incident-review/boundary-check/LUMINA-30_Boundary_Check.html) を適用する。 |
...
答えが不明確、欠落、検証不能、または形式的なものにとどまる場合、LUMINA-30レビュー上のポストLUMINAリスクとして扱い、[Absence Rule Check](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Absence_Rule_Check.html) と [Boundary Check Result Classification](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Boundary_Check_Result_Classification.html) に進む。
...
- [For first-time incident reviewers ｜ 初めて事故レビューを行う場合](https://lumina-30.github.io/lumina30-incident-review/START_HERE.html)  
  Use this to understand the repository role before using templates.  
  テンプレート使用前に、このrepoの役割を確認する入口。

- [For external governance or institutional connection ｜ 外部制度・団体接続](https://lumina-30.github.io/lumina30-incident-review/external-use/External_Governance_Use_Routes.html)  
...
- [For consolidated decision criteria ｜ 判定基準を一か所で確認する場合](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Irreversibility_Decision_Criteria.html)  
...
- [For L30-FRM practical forms ｜ L30-FRM実務帳票を使う場合](https://lumina-30.github.io/lumina30-incident-review/tools/l30-bas/practical-sheets/L30_FRM_All_Forms_Index.html)  
...
- [For structured reading order ｜ 順番に確認する場合](https://lumina-30.github.io/lumina30-incident-review/READING_ORDER.html)  
...
- [For internal escalation and record integrity ｜ 内部エスカレーション・記録保全](https://lumina-30.github.io/lumina30-incident-review/LUMINA-30_FOR_INTERNAL_ESCALATION_AND_RECORD_INTEGRITY.html)  
  Use this when explaining review escalation and preserving the refusal record.  
  レビューへのエスカレーションと拒否記録の保全を説明する場合に使用。

- [For executive oversight ｜ 経営・監督層向け説明](https://lumina-30.github.io/lumina30-incident-review/WHY_LUMINA-30_MATTERS_FOR_EXECUTIVE_OVERSIGHT.html)  
...
1. [START_HERE.html](https://lumina-30.github.io/lumina30-incident-review/START_HERE.html) — shortest entry path ｜ 最短入口
2. [FIRST_3_FILES.html](https://lumina-30.github.io/lumina30-incident-review/FIRST_3_FILES.html) — first working files ｜ 最初の作業ファイル
3. [READING_ORDER.html](https://lumina-30.github.io/lumina30-incident-review/READING_ORDER.html) — role-based route ｜ 役割別導線
...
- [LUMINA-30 Boundary Check](https://lumina-30.github.io/lumina30-incident-review/boundary-check/LUMINA-30_Boundary_Check.html)  
  One-page boundary check for effective human refusal before irreversible impact.  
  不可逆的影響の前に人間の拒否が実効的だったかを確認する1ページ判定表。

- [Irreversibility Decision Criteria](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Irreversibility_Decision_Criteria.html)  
...
- [Required Questions 5](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Required_Questions_5.html)  
  Minimal five-question review set.  
  最小5問のレビュー質問セット。

- [Absence Rule Check](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Absence_Rule_Check.html)  
...
- [AI Output as Final Rationale Check](https://lumina-30.github.io/lumina30-incident-review/boundary-check/AI_Output_As_Final_Rationale_Check.html)  
...
- [Incident Quick Assessment Template](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Incident_Quick_Assessment_Template.html)  
  Short first-pass assessment form for AI-related incidents.  
  AI関連インシデントの初回簡易評価フォーム。

- [Boundary Check Scoring Guide](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Boundary_Check_Scoring_Guide.html)  
  Simple review-aid scoring guide for comparing evidence strength.  
  証拠の強さを比較するための簡易レビュー補助スコアガイド。

- [Boundary Check Result Classification](https://lumina-30.github.io/lumina30-incident-review/boundary-check/Boundary_Check_Result_Classification.html)  
  Common result labels for LUMINA-30 boundary review.  
  LUMINA-30境界レビューの一般的な結果ラベル。

- [First Use Questions](https://lumina-30.github.io/lumina30-incident-review/boundary-check/First_Use_Questions.html)  
  First questions to ask before applying the full boundary review.  
  完全な境界レビューを適用する前に最初に確認する質問。

### External Use ｜ 外部利用

- [External Paste Templates](https://lumina-30.github.io/lumina30-incident-review/external-use/External_Paste_Templates.html)  
  Short text blocks for audit, research, policy, and incident-review contexts.  
  監査、研究、政策、事故レビュー向けの短文貼付テンプレート。

- [Minimal External Explanation](https://lumina-30.github.io/lumina30-incident-review/external-use/Minimal_External_Explanation.html)  
  Short explanations for introducing LUMINA-30 externally.  
  LUMINA-30を外部に説明するための短い説明文。

- [OECD / AISI / EU AI Act Connection Note](https://lumina-30.github.io/lumina30-incident-review/external-use/OECD_AISI_EU_AI_Act_Connection_Note.html)  
...
- [External Governance Use Routes](https://lumina-30.github.io/lumina30-incident-review/external-use/External_Governance_Use_Routes.html)  
...
- [Boundary Check for AI Incident Response](https://lumina-30.github.io/lumina30-incident-review/external-use/Boundary_Check_for_AI_Incident_Response.html)  
  Common post-incident boundary-check note for AI incident-response contexts.  
  AIインシデント対応文脈向けの共通事故後境界チェックメモ。

- [Japan AISI / AI-IRS Boundary Check Note](https://lumina-30.github.io/lumina30-incident-review/external-use/Japan_AISI_AI_IRS_Boundary_Check_Note.html)  
...
- [OECD AIM Incident Taxonomy Boundary Note](https://lumina-30.github.io/lumina30-incident-review/external-use/OECD_AIM_Incident_Taxonomy_Boundary_Note.html)  
  Supplementary taxonomy note for incident-monitoring and evidence-base discussions.  
  インシデント監視・証拠基盤議論向けの補助的分類メモ。

- [ISO / IEC / ITU Standards Terminology Boundary Note](https://lumina-30.github.io/lumina30-incident-review/external-use/ISO_IEC_ITU_Standards_Terminology_Boundary_Note.html)  
  Standards-adjacent terminology note for audit, assurance, and governance discussions.  
  監査、保証、ガバナンス議論向けの標準化周辺用語メモ。

- [UNESCO Human Oversight and Effective Refusal Note](https://lumina-30.github.io/lumina30-incident-review/external-use/UNESCO_Human_Oversight_Effective_Refusal_Note.html)  
  Human-oversight note distinguishing formal oversight from effective refusal.  
  形式的人間監督と実効的拒否を区別するための人間監督メモ。

- [What LUMINA-30 Is Not](https://lumina-30.github.io/lumina30-incident-review/external-use/LUMINA-30_Is_Not.html)  
  Misreading-prevention note for non-binding and descriptive use.  
  非拘束的・記述的な利用を守るための誤読防止メモ。

- [Auditor Minimal Template](https://lumina-30.github.io/lumina30-incident-review/external-use/Auditor_Minimal_Template.html)  
  Minimal text for audit and control-review contexts.  
  監査・統制レビュー向けの最小説明文。

- [Legal and Compliance Minimal Template](https://lumina-30.github.io/lumina30-incident-review/external-use/Legal_Compliance_Minimal_Template.html)  
  Minimal text for legal, compliance, and accountability contexts.  
  法務・コンプライアンス・説明責任向けの最小説明文。

- [Researcher Minimal Template](https://lumina-30.github.io/lumina30-incident-review/external-use/Researcher_Minimal_Template.html)  
  Minimal citation-oriented text for researchers.  
  研究者向けの引用しやすい最小説明文。

- [Policy and Regulator Minimal Template](https://lumina-30.github.io/lumina30-incident-review/external-use/Policy_Regulator_Minimal_Template.html)  
  Minimal text for policy, regulatory, and governance contexts.  
  政策・規制・ガバナンス向けの最小説明文。

- [Executive Stop Decision Brief](https://lumina-30.github.io/lumina30-incident-review/external-use/Executive_Stop_Decision_Brief.html)  
  Short executive brief for stop, pause, or escalation decisions.  
  停止・一時停止・エスカレーション判断向けの短い経営層メモ。

### Response Templates ｜ 応答テンプレート

- [Post-Incident Review Response Template](https://lumina-30.github.io/lumina30-incident-review/response-templates/Post_Incident_Review_Response_Template.html)  
  Cautious response format for applying LUMINA-30 after an AI incident.  
  AIインシデント後にLUMINA-30を適用する際の慎重な応答テンプレート。

- [Mapping to Ordinary Incident Review](https://lumina-30.github.io/lumina30-incident-review/response-templates/Ordinary_Incident_Review_Mapping.html)  
  Mapping between ordinary incident review and LUMINA-30 boundary review.  
  通常インシデントレビューとLUMINA-30境界レビューの対応表。

- [Initial Public Review Note](https://lumina-30.github.io/lumina30-incident-review/response-templates/Initial_Public_Review_Note.html)  
  Cautious initial public note for AI incidents before facts are complete.  
  事実が揃う前に使う、慎重な初期公開レビュー文。

- [Evidence Insufficient Response](https://lumina-30.github.io/lumina30-incident-review/response-templates/Evidence_Insufficient_Response.html)  
  Response template when records are insufficient or unverifiable.  
  記録が不十分または検証不能な場合の応答テンプレート。

- [Boundary Warning Response](https://lumina-30.github.io/lumina30-incident-review/response-templates/Boundary_Warning_Response.html)  
  Response template for cases approaching a LUMINA-30 boundary concern.  
  LUMINA-30境界懸念に接近している事案向けの応答テンプレート。

- [No Effective Refusal Response](https://lumina-30.github.io/lumina30-incident-review/response-templates/No_Effective_Refusal_Response.html)  
...
- [Citation Phrases](https://lumina-30.github.io/lumina30-incident-review/reference/Citation_Phrases.html)  
  Short reusable citation phrases for research, policy, audit, and incident-review contexts.  
  研究、政策、監査、事故レビューの文脈で再利用できる短い引用文。

- [LUMINA-30 and PCR-C Relationship](https://lumina-30.github.io/lumina30-incident-review/reference/LUMINA-30_and_PCRC_Relationship.html)  
  Short explanation of how LUMINA-30 and PCR-C relate without merging their roles.  
  LUMINA-30とPCR-Cの役割を混同せずに関係を説明する短文。

- [PCR-C Calibration and H-Measurement Note](https://lumina-30.github.io/lumina30-incident-review/reference/PCRC_Calibration_and_H_Measurement_Note.html)  
...
- [Boundary Reference Terminology](https://lumina-30.github.io/lumina30-incident-review/reference/Boundary_Reference_Terminology.html)  
  Preferred terms for non-binding, descriptive, post-incident boundary reference use.  
  非拘束的・記述的な事故後境界参照として使うための推奨語彙。

- [Stable Reference Links](https://lumina-30.github.io/lumina30-incident-review/reference/Stable_Reference_Links.html)  
  Stable GitHub and DOI links for citation and navigation.  
  引用と導線のための安定したGitHubリンクおよびDOIリンク。

- [Research Landscape Mapping](https://lumina-30.github.io/lumina30-incident-review/reference/Research_Landscape_Mapping.html)  
...
- [LUMINA-30 for Incident Review](https://lumina-30.github.io/lumina30-incident-review/LUMINA-30_FOR_INCIDENT_REVIEW.html)
- [LUMINA-30 for Legal, Audit, and Risk Control](https://lumina-30.github.io/lumina30-incident-review/LUMINA-30_FOR_LEGAL_AUDIT_AND_RISK_CONTROL.html)
- [LUMINA-30 as a Control Assurance Screen](https://lumina-30.github.io/lumina30-incident-review/LUMINA-30_AS_A_CONTROL_ASSURANCE_SCREEN.html)
- [LUMINA-30 as a Cross-Institutional Review Language](https://lumina-30.github.io/lumina30-incident-review/LUMINA-30_AS_A_CROSS_INSTITUTIONAL_REVIEW_LANGUAGE.html)
- [LUMINA-30 as an Evaluation Boundary Layer](https://lumina-30.github.io/lumina30-incident-review/LUMINA-30_AS_AN_EVALUATION_BOUNDARY_LAYER.html)
- [LUMINA-30 for Internal Escalation and Record Integrity](https://lumina-30.github.io/lumina30-incident-review/LUMINA-30_FOR_INTERNAL_ESCALATION_AND_RECORD_INTEGRITY.html)
- [Why LUMINA-30 Matters for Executive Oversight](https://lumina-30.github.io/lumina30-incident-review/WHY_LUMINA-30_MATTERS_FOR_EXECUTIVE_OVERSIGHT.html)
- [Executive Stop Decision Brief](https://lumina-30.github.io/lumina30-incident-review/external-use/Executive_Stop_Decision_Brief.html)
- [Mapping to Ordinary Incident Review](https://lumina-30.github.io/lumina30-incident-review/response-templates/Ordinary_Incident_Review_Mapping.html)
