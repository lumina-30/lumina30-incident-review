...
能力評価や安全性評価は必要である。  
しかし、それだけでは、境界喪失前に人間拒否がなお有効だったかを確認する共通言語を常に与えるわけではない。
...
- absence of verifiable refusal path
- loss of pre-irreversibility intervention
- boundary-condition warning
