...
以下がすべて示される場合に限り、このラベルを使用する。

- Human final refusal was available before irreversible impact.
- Refusal was operationally effective, not merely nominal.
- Records are sufficient to verify the refusal pathway.
- AI-generated output did not become the sole or primary final rationale.

- 不可逆的影響の前に人間の最終拒否が可能だった。
- 拒否は名目上ではなく、運用上実効的だった。
- 拒否経路を検証できる十分な記録がある。
...
拒否経路を検証する記録が不十分な場合に使用する。

For LUMINA-30 boundary-review purposes, this should not be treated as demonstrated effective refusal.
...
The available records indicate that human final refusal authority remained operationally effective before irreversible impact.

利用可能な記録は、不可逆的影響の前に人間の最終拒否権が運用上実効的に残っていたことを示している。

### Effective Refusal Not Demonstrated

The available records do not demonstrate effective human refusal before irreversible impact.

利用可能な記録は、不可逆的影響の前に実効的な人間の拒否が存在したことを示していない。
