...
This file defines a recommended reading order for incident reviewers, auditors, researchers, policy readers, and executives.

本ファイルは、インシデントレビュー担当者、監査担当者、研究者、政策関係者、経営層向けの推奨読書順を定義する。

## Immediate Incident Route / 事故時の即応導線

Use this route when facts are incomplete and a first boundary review must be started quickly.

事実が揃っていない段階で、最初の境界レビューをすぐ開始する場合はこの順序を使う。
...
4. [Absence Rule Check](./boundary-check/Absence_Rule_Check.md)
5. [Boundary Check Result Classification](./boundary-check/Boundary_Check_Result_Classification.md)
6. [Initial Public Review Note](./response-templates/Initial_Public_Review_Note.md)
...
1. [FIRST_3_FILES.md](./FIRST_3_FILES.md)
2. [Incident Quick Assessment Template](./boundary-check/Incident_Quick_Assessment_Template.md)
3. [AI Output as Final Rationale Check](./boundary-check/AI_Output_As_Final_Rationale_Check.md)
